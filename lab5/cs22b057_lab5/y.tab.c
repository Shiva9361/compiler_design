...
#define YYTRANSLATE(x) ((unsigned)(x) <= 268 ? yytranslate[x] : 21)
...
static const short yyprhs[] = {     0,
     0,     3,     4,     9,    12,    15,    19,    23,    25,    29,
    33,    37,    39,    41,    44,    46,    49,    51,    54,    58,
    62,    64,    67,    69,    72,    74,    77,    81
};

static const short yyrhs[] = {    16,
    15,     0,     0,     3,    10,    17,    14,     0,    17,    14,
     0,     1,    14,     0,    17,     6,    18,     0,    17,     7,
    18,     0,    18,     0,    18,     8,    19,     0,    18,     9,
    19,     0,    18,    11,    20,     0,    19,     0,     4,     0,
     7,     4,     0,     5,     0,     7,     5,     0,     3,     0,
     7,     3,     0,    12,    17,    13,     0,    12,    17,     1,
     0,     4,     0,     7,     4,     0,     5,     0,     7,     5,
     0,     3,     0,     7,     3,     0,    12,    17,    13,     0,
    12,    17,     1,     0
};
...
static const short yyrline[] = { 0,
    37,    37,    38,    39,    40,    42,    43,    44,    47,    48,
    49,    50,    53,    54,    55,    56,    57,    58,    59,    60,
    63,    64,    65,    66,    67,    68,    69,    70
};

static const char * const yytname[] = {   "$","error","$illegal.","IDEN","INT",
"FLOAT","PLUS","MINUS","STAR","DIV","EQUAL","MOD","LPAREN","RPAREN","';'","S",
"A","EXPR","TERM","FAC","FACI",""
};
#endif
...
static const short yydefact[] = {     0,
     0,    17,    13,    15,     0,     0,     0,     0,     8,    12,
     5,     0,    18,    14,    16,    17,     0,     1,     0,     0,
     4,     0,     0,     0,     0,    20,    19,     6,     7,     9,
    10,    25,    21,    23,     0,     0,    11,     3,    26,    22,
    24,     0,    28,    27,     0,     0,     0
};
...
static const short yypact[] = {     4,
   -13,     3,-32768,-32768,    40,    24,     4,    -4,    14,-32768,
-32768,    24,-32768,-32768,-32768,-32768,    11,-32768,    24,    24,
-32768,    24,    24,    30,    32,-32768,-32768,    14,    14,-32768,
-32768,-32768,-32768,-32768,    44,    24,-32768,-32768,-32768,-32768,
-32768,    13,-32768,-32768,    15,    52,-32768
};
...
static const short yytable[] = {    17,
    11,    19,    20,    -2,     1,    25,     2,     3,     4,    21,
     5,    26,    12,    43,    46,     6,    19,    20,    19,    20,
     0,    22,    23,    27,    24,    44,    16,     3,     4,    42,
     5,     0,    32,    33,    34,     6,    35,    19,    20,    28,
    29,    36,    13,    14,    15,    38,    39,    40,    41,    30,
    31,    47,    45
};

static const short yycheck[] = {     6,
    14,     6,     7,     0,     1,    12,     3,     4,     5,    14,
     7,     1,    10,     1,     0,    12,     6,     7,     6,     7,
    -1,     8,     9,    13,    11,    13,     3,     4,     5,    36,
     7,    -1,     3,     4,     5,    12,     7,     6,     7,    19,
    20,    12,     3,     4,     5,    14,     3,     4,     5,    22,
    23,     0,     0
};
...
case 3:
#line 38 "prob3.y"
{if (eflag){printf("%s -> %s -> Could not construct Syntax Tree\n",buffer,error);eflag=0;error[0]="\0";buffer[0]='\0';} else {yyval.node = createNode("=",createNode(yyvsp[-3].str,NULL,NULL),yyvsp[-1].node);printf("%s -> \nPost-Order: ",buffer);postorder(yyval.node);buffer[0]='\0';printf("\n");};
    break;}
case 4:
#line 39 "prob3.y"
{if (eflag){printf("%s -> %s -> Could not construct Syntax Tree\n",buffer,error);eflag=0;error[0]="\0";buffer[0]='\0';} else {yyval.node=yyvsp[-1].node;printf("%s -> \nPost-Order: ",buffer);postorder(yyval.node);buffer[0]='\0';printf("\n");};
    break;}
case 5:
#line 40 "prob3.y"
{if (eflag){eflag=0;error[0]='\0';}printf("%s -> Invalid Statement -> Could not construct Syntax Tree\n",buffer);yyerrok;buffer[0]='\0';;
    break;}
case 6:
#line 42 "prob3.y"
...
case 14:
#line 54 "prob3.y"
{ yyval.node = createNode("-", createNode(yyvsp[0].str, NULL, NULL), NULL); ;
    break;}
case 15:
#line 55 "prob3.y"
{ yyval.node = createNode(yyvsp[0].str, NULL, NULL); ;
...
case 20:
#line 60 "prob3.y"
{ strcpy(error, "Missing Right Parenthesis"); eflag = 1; yyerrok; ;
    break;}
case 21:
#line 63 "prob3.y"
{ yyval.node = createNode(yyvsp[0].str, NULL, NULL); ;
...
case 22:
#line 64 "prob3.y"
{ strcpy(error,"Invalid Operand"); eflag=1;yyval.node = createNode("", NULL, NULL); ;
    break;}
case 23:
#line 65 "prob3.y"
{ strcpy(error, "Invalid Operand"); eflag = 1; yyval.node = createNode("", NULL, NULL); ;
