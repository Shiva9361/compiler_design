...
const int YY_parser_CLASS::MONTH=258;
const int YY_parser_CLASS::DAY=259;
const int YY_parser_CLASS::YEAR=260;
const int YY_parser_CLASS::SEP=261;
...
static const char * const yytname[] = {   "$","error","$illegal.","MONTH","DAY",
"YEAR","SEP","';'","S","A",""
};
#endif
...
case 3:
#line 20 "prob3.y"
{if (check(yyvsp[-4].day,yyvsp[-2].mon,yyvsp[0].year)) printf("Accepted\n"); else printf("Rejected\n");
    break;}
}
